...
public class UndirectedPairGeneratorTest {
    ...
    void shouldProduceASequenceOfUniquePairs(){
        ...
        assertEquals(Pair.of("1", "2"), gen.getNextPair());
        assertEquals(Pair.of("1", "3"), gen.getNextPair());
        assertEquals(Pair.of("1", "4"), gen.getNextPair());
        assertEquals(Pair.of("1", "5"), gen.getNextPair());
        // 2,1 would be double
        assertEquals(Pair.of("2", "3"), gen.getNextPair());
        assertEquals(Pair.of("2", "4"), gen.getNextPair());
        assertEquals(Pair.of("2", "5"), gen.getNextPair());
        // 3, 1 would be double
        // 3, 2 would be double
        assertEquals(Pair.of("3", "4"), gen.getNextPair());
        assertEquals(Pair.of("3", "5"), gen.getNextPair());
        // 4, 1 would be double
        // 4, 2 would be double
        // 4, 3 would be double
        assertEquals(Pair.of("4", "5"), gen.getNextPair());
